...
>
  <head>
    ...
    <title>Room Finder Account</title>
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="add_room.php"
                        ><i class="bx bx-bell me-1"></i> Add Room</a
                      >
                    </li>
                  </ul>
                  <div class="card mb-4">
                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="lastName" id="lastName" value="Doe" placeholder="Last Name"/>
                          </div>
                          <div class="mb-3 col-md-6">
